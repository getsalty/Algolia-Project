...
const IndexCardContainer = (props: Props) => {
  ...
  return (
    <div className={currentStep ? 'dashed-border' : ''}>
      <div className="flex items-center h-18 w-40 border rounded-[3px] flex-col justify-center bg-white shadow-[0_0_0_1px_rgba(35,38,59,.05),0_1px_3px_0_rgba(35,38,59,.15)]">
